...
public class ActivityMoshavereh extends AppCompatActivity {

    RecyclerView recyclerView;
    AdapterMoshavereh adapter;
    ...
    public void init() {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityMoshavereh.this, ActivityMain.class));
                finish();
            }
        });
        ...
        adapter = new AdapterMoshavereh(list);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setAdapter(adapter);
    }

    public void readData() {
        formDialog = new ProgressDialog(ActivityMoshavereh.this);
        formDialog.setMessage("صبر کنید ...");
        formDialog.setIndeterminate(false);
        formDialog.setCancelable(true);
        formDialog.show();
        AndroidNetworking.post(url)
                .addBodyParameter("action", "getConsultation")
