...
public class ActivityTextVakil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_text_vakil);
        init();
        readData();
    }
    ...
    public void init() {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityTextVakil.this, ActivityVakil.class));
                finish();
            }
        });
