...
public class ActivityArshiv extends AppCompatActivity {

    RecyclerView recyclerView;
    AdapterArshiv adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arshiv);
        init();
        readData();
    }
    ...
    public void init() {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityArshiv.this, ActivityMain.class));
                finish();
            }
        });
